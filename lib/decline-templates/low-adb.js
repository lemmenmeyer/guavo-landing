...
module.exports = {
  label: 'Low ADB',
  bullet: () =>
    'Your weekly cash reserve was below the minimum we can approve for this program.',
  threshold: () => APPROX_RESERVE_FLOOR == null ? null : `a weekly cash reserve of at least ${APPROX_RESERVE_FLOOR}`,
