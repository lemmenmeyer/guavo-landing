...
// Applicant-facing copy says "credit score", not "FICO" — the score actually
// pulled is VantageScore 4 (see SCORE_MODEL in common.js), so naming FICO
// here would misstate the model the decision used.
...
module.exports = {
  ...
  threshold: () => APPROX_FICO_FLOOR == null ? null : `a credit score of at least ${APPROX_FICO_FLOOR}`,
