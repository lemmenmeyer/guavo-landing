...
async function updateStatusIndex(itemId, columnId, index) {
  return mondayFetch(`
    mutation SetStatus($itemId: ID!, $columnId: String!, $value: JSON!) {
      change_column_value(
        item_id:   $itemId,
        column_id: $columnId,
        value:     $value
...
async function updateStatusLabel(itemId, columnId, label) {
  return mondayFetch(`
    mutation SetStatusLabel($itemId: ID!, $columnId: String!, $value: JSON!) {
      change_column_value(
        item_id:   $itemId,
        column_id: $columnId,
        value:     $value
...
async function updateText(itemId, columnId, text) {
  return mondayFetch(`
    mutation SetText($itemId: ID!, $columnId: String!, $value: JSON!) {
      change_column_value(
        item_id:   $itemId,
        column_id: $columnId,
        value:     $value
