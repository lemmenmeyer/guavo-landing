...
module.exports = {
  ...
  // Removed 2026-07-18: 'Unlock Experian' template deleted. Unlock-Experian
  // asks are now hand-drafted per-item (tighter tone, per-deal signer). If
  // volume ever justifies a template again, rebuild it here.
  //
